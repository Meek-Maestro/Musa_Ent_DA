...
const CustomerAccountingPrint = forwardRef<HTMLDivElement, { customerAccounting: any[] }>(
  ({ customerAccounting }, ref) => {
    return (
      <div ref={ref} style={{ padding: "20px", fontSize: "14px", fontFamily: "Arial, sans-serif" }}>
        <h2 style={{ textAlign: "center", marginBottom: "20px" }}>Customer Accounting Report</h2>
...
export default CustomerAccountingPrint;